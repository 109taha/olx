...
const createUser = async (req, res) => {
    try {
        const { username, email, password, first_name, last_name, phone_number, location } = req.body;
        console.log(req.body)
        if (!username || !email || !password || !first_name || !last_name || !phone_number || !location) {
